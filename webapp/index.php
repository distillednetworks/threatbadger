...
<title>ThreatBadger — Threat Intelligence Portal</title>
...
<div class="login-page">
  <div class="login-card">
    <div class="login-logo">
      <div class="logo-icon"><img src="assets/img/logo-large.png" width=300px/></div>
    </div>
...
<div id="app">
  ...
  <div class="topbar">
    <div class="topbar-left">
      <div class="logo">
        <div class="logo-icon"><img src="assets/img/logo-mini.png" /></div>
        <div class="logo-header">
          <span class="logo-text">THREATBADGER</span>
      ...
      <nav class="topnav">
        ...
        <button class="nav-btn" data-view="hunt" onclick="switchView('hunt', this)">🎯 Hunt</button>
  ...
  <div class="main-wrap">
    ...
    <div id="view-lookup" class="view active">
      ...
      <div id="lookup-empty" class="empty-state">
        ...
        <div class="empty-sub">Supports IPv4 · IPv6 ·Domain · Email · MD5 · SHA-1 · SHA-256</div>
      </div>
    ...
    <div id="view-hunt" class="view">
      ...
      <!-- Search bar -->
      <div class="search-bar">
        <input type="text" id="hunt-input" class="search-input"
          placeholder="1.1.1.1 · malicious.com · email@mail.com · d41d8cd98f…"
          oninput="huntUpdateTypeBadgeFromInput()"
          onkeydown="if(event.key==='Enter')doHunt()">
        <button class="btn-search" id="hunt-btn" onclick="doHunt()">Hunt →</button>
      </div>

      <!-- Time range + index row -->
      <div class="hunt-options-row">
        <!-- Time range -->
        <div class="hunt-option-group">
          <label class="hunt-option-label">Time Range</label>
          <div class="hunt-time-wrap">
            <div class="hunt-time-tabs" id="hunt-time-tabs">
              <button class="hunt-time-tab active" data-mode="relative" onclick="huntSetTimeMode('relative')">Relative</button>
              <button class="hunt-time-tab" data-mode="absolute" onclick="huntSetTimeMode('absolute')">Absolute</button>
            </div>

            <!-- Relative mode -->
            <div id="hunt-time-relative" class="hunt-time-panel">
              <div id="hunt-time-rel-options" class="hunt-time-rel-options">
                <span class="hunt-option-label" style="margin:0">Last</span>
                <input type="number" id="hunt-rel-value" class="form-input hunt-rel-input"
                  value="30" min="1" max="9999" onkeydown="if(event.key==='Enter')doHunt()">
                <select id="hunt-rel-unit" class="form-input hunt-rel-select"
                  onchange="huntUpdateRelativeLabel()">
              ...
              <div id="hunt-rel-preview-cont" class="hunt-rel-preview-cont">
                <span id="hunt-rel-preview" class="hunt-time-preview"></span>
              </div>
            </div>

            <!-- Absolute mode -->
            <div id="hunt-time-absolute" class="hunt-time-panel" style="display:none">
              <input type="datetime-local" id="hunt-abs-from" class="form-input hunt-abs-input"
                onkeydown="if(event.key==='Enter')doHunt()">
              <span class="hunt-option-label" style="margin:0 4px">→</span>
              <input type="datetime-local" id="hunt-abs-to" class="form-input hunt-abs-input"
                onkeydown="if(event.key==='Enter')doHunt()">
            </div>
          </div>
        </div>
      ...
      <div id="hunt-type-badge" style="min-height:22px;margin-top:4px;margin-bottom:12px"></div>

      <!-- Error -->
      <div id="hunt-error" class="error-box" style="display:none"></div>

      <!-- Loading -->
      <div id="hunt-loading" style="display:none;text-align:center;padding:48px 0">
        <div style="font-family:var(--mono);font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:var(--muted);margin-bottom:12px">Hunting across logs</div>
        <div class="dots-loader"><div></div><div></div><div></div></div>
      </div>
      ...
      <!-- Results -->
      <div id="hunt-results" style="display:none"></div>
    </div>
    ...
    <div id="view-history" class="view">
      ...
      <div class="filter-row">
        ...
        <select class="form-input" id="hist-type" onchange="filterHistory()" style="max-width:160px">
          ...
          <option value="IPv6 Address">IPv6</option>
    ...
    <div id="view-settings" class="view">
      <div class="view-header">
        ...
        <div class="btn-row">
         <img src="assets/img/logo-mini.png" width="80px" height="80px" />
        </div>
      </div>
